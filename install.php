...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhtc_goods')."(
  ...
  `goods_cost` decimal(10,2)  NOT NULL COMMENT '商品价格',
...
pdo_query("CREATE TABLE IF NOT EXISTS".tablename('zhtc_coupons')."(
  ...
  `full` varchar(20) NOT NULL COMMENT '满',
...
if (!pdo_fieldexists(tablename('zhtc_system'), 'tzmc')) {
  pdo_query("ALTER TABLE".tablename('zhtc_system')." ADD `tzmc` VARCHAR(20) NOT NULL;");
}
if (!pdo_fieldexists(tablename('zhtc_system'), 'tzmc')) {
...
if (!pdo_fieldexists(tablename('zhtc_system'), 'model')) {
  pdo_query("ALTER TABLE".tablename('zhtc_system')." ADD `model` INT(11) NOT NULL  DEFAULT '1';");
}
